...
class covidModel:
    ...
    def __init__(self,subgroups, expandModel, observeLevel='primary', add_interventions='baseline',
                 ...
                 add_migration=False, fit_params=None,emodl_name=None, sim_dir=sim_dir):
        self.model = 'locale'
        ...
        self.emodl_dir = os.path.join(sim_dir, 'emodl')
    ...
    def write_interventions(self, total_string):
        ...
        def write_vaccine():
            ...
            df = pd.read_csv(os.path.join(sim_dir,"experiment_configs", 'input_csv', 'vaccination_fractionSevere_adjustment_IL.csv'))
            df['Date'] = pd.to_datetime(df['date'])
