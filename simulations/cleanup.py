...
def cleanup(exp_name, wdir, sim_out_dir, keep_simsfiles=False, keep_single_trajectories=False):
...
if __name__ == '__main__':
    ...
    sim_out_dir = os.path.join(sim_dir, "_temp")

    exp_names = [x for x in os.listdir(sim_out_dir) if stem in x]
    for exp_name in exp_names:
        print(exp_name)

        cleanup(exp_name, wdir, sim_out_dir, keep_simsfiles=True, keep_single_trajectories=True)
